...
<html><head><title>Bercy Astar Pay</title>
<style>
...
<h1>🔺 Bercy Astar Pay</h1>
<p>World's first <b>x402 + AC2</b> cross-border payment layer on Astar Mainnet.</p>
<div>
...
app.get("/api/health", async (req, res) => {
  try {
    ...
    res.json({ status: "ok", service: "Bercy Astar Pay", network: "Astar Mainnet", protocols: ["x402", "AC2"], totalCorridors: 95 });
  }
});
...
app.listen(PORT, () => console.log("Bercy Astar Pay running on port " + PORT));
